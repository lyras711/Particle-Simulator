...
const ControlPanel: React.FC<ControlPanelProps> = ({ currentParams, onUpdate, isRecording, onToggleRecording }) => {
  ...
  return (
    <div className="absolute top-0 left-0 h-full w-full md:w-96 p-6 pointer-events-none flex flex-col justify-between z-10">
      
      {/* Top Section: AI Input */}
      <div className="bg-black/80 backdrop-blur-md rounded-2xl p-6 border border-white/10 pointer-events-auto shadow-2xl">
